...
public class Ventana_1 extends JFrame
{
    ...
    public void login(){
        ...
        JLabel textoAcceder = new JLabel("Acceder");
        textoAcceder.setBounds(100, 45, 800, 100);
        textoAcceder.setOpaque(true);
        textoAcceder.setBackground(Color.red);
        textoAcceder.setHorizontalAlignment(SwingConstants.CENTER);
        textoAcceder.setFont(new Font("Arial", Font.BOLD, 72));
        textoAcceder.setForeground(Color.WHITE);
        login.add(textoAcceder);
        ...
        login_btn.addActionListener(new ActionListener); {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String usuraio = usuario_field.getText();
                String contraseña = new String(contraseña_field.getPassword());

                System.out.println("");  //Se pone la variable del usuario
                System.out.println("");  //Se pone la variable de la contraseña

                if(usuario.equals("SuperUsuario")) {
                    if(contraseña.equals("SuperContraseña")) { 

                        System.out.print("Bienvenido Super Uusario");
                    }
    ...
    public void paint(Graphics g)
    {
        ...
        //Fondo de la ventana
        g2d.setColor(Color.decode("#7EF3E3"));
        g2d.fillRect(0, 0, 1000, 700);

        //Color del piso
        g2d.setColor(Color.decode("#EC762F"));
        g2d.fillRect(0, 620, 1000, 80);
        //Segunda seccion del piso
        g2d.setColor(Color.decode("#F5C3A4"));
        g2d.fillRect(0, 590, 1000, 30);

        //Fondo del cuadrado azul
        g2d.setColor(Color.black);
        g2d.fillRect(270, 460, 150, 140);

        //Cuadrado azul del fondo
        g2d.setColor(Color.decode("#06B4D7"));
        g2d.fillRect(250, 420, 150, 200);

        //Fondo del cuadrado baige

        //Cuadrado de color Baige
